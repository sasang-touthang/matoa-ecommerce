...
function createNewUser(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Create new user
            const newUser = new User(Object.assign(Object.assign({}, req.body), { password: bcrypt.hashSync(req.body.password, 10), cart: newCart._id }));
            // Reference new user
...
function userLogin(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const checkPassword = yield bcrypt.compare(req.body.password, user.password);
            if (!user) {
            ...
            res
                .status(500)
                .json({ message: "User does not exist. Please enter a correct email." });
        }
    });
}
// Get number of users
